...
namespace SaferMS.Controllers
{
    public class DepartamentosController : Controller
    {
        ...
        public DepartamentosController(Safer3Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("IdDepartamento,NomDepartamento")] Departamento departamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdDepartamento,NomDepartamento")] Departamento departamento)
        {
